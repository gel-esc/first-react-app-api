...
export const NavBar = () => {
    ...
    return (
        <nav className='bg-gradient-to-r from-pink-400 via-purple-300 to-indigo-300 flex justify-between items-center fixed z-10 top-0 w-full py-5 px-8 text-m font-bold '>
